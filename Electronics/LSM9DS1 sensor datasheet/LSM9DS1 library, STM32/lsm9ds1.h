...
// Additions for Kalman Filter

// Added Kalman_t data struct
typedef struct{
	double Q_angle;
	double Q_bias;
	double R_measure;
...
uint8_t LSM9DS1_Init(I2C_HandleTypeDef *I2Cx);

void LSM9DS1_Read_Accel(I2C_HandleTypeDef *I2Cx, LSM9DS1_t *DataStruct);

void LSMDS1_Read_Gyro(I2C_HandleTypeDef *I2Cx, LSM9DS1_t *DataStruct);

void LSM9DS1_Read_Temp(I2C_HandleTypeDef *I2Cx, LSM9DS1_t *DataStruct);
