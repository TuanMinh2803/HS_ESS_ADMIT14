###########################################################################
## Makefile generated for component 'arduino_CAN_simple_example'. 
## 
## Makefile     : arduino_CAN_simple_example.mk
## Generated on : Tue Mar 25 16:22:15 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/arduino_CAN_simple_example.elf
...
PRODUCT_NAME              = arduino_CAN_simple_example
MAKEFILE                  = arduino_CAN_simple_example.mk
MATLAB_ROOT               = D:/MATLAB/R2024b
MATLAB_BIN                = D:/MATLAB/R2024b/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = E:/BACKUP/STUDIEREN/Bücher Master/Master thesis/CANBUS Module/arduino_CAN-master LL43
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
SLIB_PATH                 = C:/Users/Minh/DOCUME~1/MATLAB/R2024b/ARDUIN~1/ARDUIN~2/FASTER~1
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/arduino_CAN_simple_example.elf
...
INCLUDES_BUILDINFO = -I$(START_DIR) -IC:/ProgramData/MATLAB/SupportPackages/R2024b/toolbox/target/supportpackages/arduinobase/include -I$(START_DIR)/arduino_CAN_simple_example_ert_rtw -I$(START_DIR)/externals/CAN-Bus_Shield/Libraries/Canbus -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(ARDUINO_AVR_ROOT)/hardware/avr/$(AVR_LIB_VERSION)/cores/arduino -I$(ARDUINO_AVR_ROOT)/hardware/avr/$(AVR_LIB_VERSION)/variants/standard -IC:/ProgramData/MATLAB/SupportPackages/R2024b/toolbox/target/supportpackages/arduinotarget/include -IC:/ProgramData/MATLAB/SupportPackages/R2024b/toolbox/target/supportpackages/arduinotarget/scheduler/include -I$(ARDUINO_AVR_ROOT)/tools/avr-gcc/$(AVR_GCC_LIB_VERSION)/avr/include
...
DEFINES_STANDARD = -DMODEL=arduino_CAN_simple_example -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = C:/ProgramData/MATLAB/SupportPackages/R2024b/toolbox/target/supportpackages/arduinobase/src/MW_arduino_digitalio.cpp $(START_DIR)/arduino_CAN_simple_example_ert_rtw/RxCANmsg.c $(START_DIR)/arduino_CAN_simple_example_ert_rtw/arduino_CAN_simple_example.c $(START_DIR)/arduino_CAN_simple_example_ert_rtw/arduino_CAN_simple_example_data.c $(START_DIR)/externals/CAN-Bus_Shield/Libraries/Canbus/mcp2515.c C:/ProgramData/MATLAB/SupportPackages/R2024b/toolbox/target/supportpackages/arduinotarget/src/MW_ArduinoHWInit.cpp C:/ProgramData/MATLAB/SupportPackages/R2024b/toolbox/target/supportpackages/arduinobase/src/io_wrappers.cpp C:/ProgramData/MATLAB/SupportPackages/R2024b/toolbox/target/supportpackages/arduinotarget/scheduler/src/arduinoAVRScheduler.cpp

MAIN_SRC = $(START_DIR)/arduino_CAN_simple_example_ert_rtw/ert_main.c
...
OBJS = MW_arduino_digitalio.o RxCANmsg.o arduino_CAN_simple_example.o arduino_CAN_simple_example_data.o mcp2515.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o
...
%.o : $(START_DIR)/arduino_CAN_simple_example_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/arduino_CAN_simple_example_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/arduino_CAN_simple_example_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
RxCANmsg.o : $(START_DIR)/arduino_CAN_simple_example_ert_rtw/RxCANmsg.c
	$(CC) $(CFLAGS) -o "$@" "$<"


arduino_CAN_simple_example.o : $(START_DIR)/arduino_CAN_simple_example_ert_rtw/arduino_CAN_simple_example.c
	$(CC) $(CFLAGS) -o "$@" "$<"


arduino_CAN_simple_example_data.o : $(START_DIR)/arduino_CAN_simple_example_ert_rtw/arduino_CAN_simple_example_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/arduino_CAN_simple_example_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
