...
#define	AGB0_REG_INT_PIN_CFG					0x0F
...
#define	AGB0_REG_FIFO_RST						0x68
#define	AGB0_REG_FIFO_MODE						0x69
#define	AGB0_REG_FIFO_COUNTH					0x70
#define	AGB0_REG_FIFO_COUNTL					0x71
...
void ak09916_init();
		...
		//16bit ADC val, raw data
void icm20948_gyro_read(axes* data);
void icm20948_accel_read(axes* data);
bool ak09916_mag_read(axes* data);

		//Convert 16bit ADC to physical value measurement

void icm20948_gyro_read_dps(axes* data);
...
//Calibration before selecting full scale
